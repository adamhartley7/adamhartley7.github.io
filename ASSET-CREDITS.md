...
- File: `assets/eht-m87-black-hole.webp`
- Subject: M87*, reconstructed from Event Horizon Telescope observations
- Credit: EHT Collaboration
- Source: https://www.eso.org/public/images/eso1907a/
- License: Creative Commons Attribution 4.0
- Usage guidance: https://www.eso.org/public/outreach/copyright/

## Analyzer beach background

- File: `assets/analyzer-ocean-sunset.webp`
- Subject: an empty beach and ocean horizon at sunset
